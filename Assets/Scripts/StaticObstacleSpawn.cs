...
public class StaticObstacleSpawn : MonoBehaviour
{
    ...
    public static StaticObstacleSpawn instance;
    ...
    private void Start()
    {
        ...
        //instance = this;
            ...
            {
                spawnPoints[i].transform.position = new Vector3(-6 + posX, transform.position.y,transform.position.z);
                posX = posX + offset;
            }
